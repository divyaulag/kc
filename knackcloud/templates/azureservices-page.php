...
<body>
		...
		<h1 class="heading">Azure Certifications</h1>
		<table class="table1">
			<thead>
				<tr>
					<th>S.NO</th>
			...
			<tbody>
				...
				<tr>
					...
					<input type="hidden" name="tname" value="Azure Developer Associate">
        ...
        <h1 class="heading">Azure Services</h1>
		<table class="table2">
			<thead>
				<tr>
					<th>S.NO</th>
			...
			<tbody>
				...
				<tr>
						...
						<td>10</td>
						<td>10 minutes</td>
						<input type="hidden" name="topicname" value="Kubernetes">
				...
				<tr>
						...
						<td>10</td>
						<td>10 minutes</td>
						<input type="hidden" name="topicname" value="Data Lake">
						<input type="hidden" name="noq" value="10">
						<input type="hidden" name="time" value="10">
						<td><button class="btn">Start</button></td>
