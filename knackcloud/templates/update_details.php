...
<div class="wrapper" >
  <div class="c">
        <p style="text-align: center; font-size: 23px;font-family: 'Lato';color:#1ABC9C; ">Update your certification details!</p><br>
        <form id="search">
        ...
        <div style="text-align: center;">
          ...
          <div id="emp_no"><br>
            ...
            <input type="number" style="width:300px;height:40px;border: 1px solid green;border-color:#1ABC9C;padding:10px; "   id="empn" name="emp_no" required /><br>
              
              <select class="form-control" style="width:300px;height:40px;border: 1px solid green; border-color:#1ABC9C;margin-top:20px;" id="c_name">
          ...
          <option value="GCP Certified Machine Learning Engineer Professional">GCP Certified Machine Learning Engineer Professional</option>
            ...
            <input style="padding: 0px;color:white;font-size: 17px;color:white;background-color: black;" id="submit" type="submit" class="btn-next" value="Get">
          </div>
